         ...
         <div className="tg-listing-map-filter pt-25 pb-15">
            <div className="item-select mb-10">
               <NiceSelect
                  ...
                  options={[
                     { value: "01", text: "Car Type" },
                     { value: "02", text: "Economy" },
                     { value: "03", text: "Compact" },
                     { value: "04", text: "SUV" },
                     { value: "05", text: "Luxury" },
                     { value: "06", text: "Convertible" },
                  ]}
                  defaultCurrent={0}
            ...
            <div className="item-select mb-10">
               <NiceSelect
                  className="select"
                  options={[
                     { value: "01", text: "Features" },
                     { value: "02", text: "GPS" },
                     { value: "03", text: "Bluetooth" },
                     { value: "04", text: "Child Seat" },
                     { value: "05", text: "Insurance" },
                  ]}
                  defaultCurrent={0}
                  onChange={selectHandler}
                  name=""
            ...
            <div className="row align-items-center">
               <div className="col-xl-5 mb-15">
                  <div className="tg-listing-box-number-found">
                     <span>3,269 cars available</span>
                  </div>
               </div>
