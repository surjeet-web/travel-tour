...
const FeatureArea = () => {
   ...
   // Use car rental data instead of products
   const filteredProducts = car_rental_data.filter((item: CarRentalType) => item.page === "car_rental");
                  ...
                  <div className="tg-listing-map-list-wrap mb-15">
                     ...
                     <div className="tg-listing-map-filter-wrap pl-40 pr-35">
                        ...
                        <div className="tg-listing-map-list-item">
                           <div className="row">
                              {currentItems.map((item: CarRentalType) => (
                                    ...
                                    <div className="tg-listing-card-item tg-listing-4-card-item mb-25">
                                       <div className="tg-listing-card-thumb tg-listing-2-card-thumb mb-15 fix p-relative">
                                          <Link to={`/car-details/${item.id}`}>
                                             <img className="tg-card-border w-100" src={item.thumb} alt="car rental" />
                                             ...
                                             {item.available && <span className="tg-listing-item-price-discount offer-btm shape-2">{item.available}</span>}
                                          </Link>
                                       </div>
                                       <div className="tg-listing-card-content mb-15 p-relative">
                                          <div className="d-flex justify-content-between">
                                             <div className="mr-30">
                                                <h4 className="tg-listing-card-title mb-5"><Link to={`/car-details/${item.id}`}>{item.year} {item.make} {item.model}</Link></h4>
                                                ...
                                                <div className="tg-listing-card-review mb-10">
                                                   ...
                                                   <span className="tg-listing-rating-icon"><i className="fa-sharp fa-solid fa-star"></i></span>
                                                   <span className="tg-listing-rating-icon"><i className="fa-sharp fa-solid fa-star"></i></span>
                                                   <span className="tg-listing-rating-percent">({item.total_reviews})</span>
                                                </div>
                                             </div>
                                          ...
                                          <p className="tg-listing-map-list-para mb-25">{item.fuel_type} • {item.mileage_limit}</p>
                                          <div className="tg-listing-avai d-flex align-items-center justify-content-between">
                                             <div className="tg-listing-2-price">
                                                ...
                                                <span className="new">${item.price_per_day}</span>
                                                <span className="shift">/day</span>
                                             </div>
                                             <Link className="tg-listing-avai-btn" to={`/car-details/${item.id}`}>Book Now</Link>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
