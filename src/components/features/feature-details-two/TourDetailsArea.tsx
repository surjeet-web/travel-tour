         ...
         <div className="tg-tour-details-area pt-20">
            <div className="container">
               <div className="text-center">
                  ...
                  <Link to="/car-listing" className="tg-btn tg-style1">
                     Back to Car Listing
                  </Link>
               </div>
            </div>
            ...
            <div className="row align-items-end mb-25">
               <div className="col-xl-9 col-lg-8">
                  <div className="tg-tour-details-video-title-wrap">
                     <h2 className="tg-tour-details-video-title mb-15">{carData.year} {carData.make} {carData.model}</h2>
                     <div className="tg-tour-details-video-location d-flex flex-wrap">
                        <div className="tg-tour-details-video-feature-price mb-10 mr-25">
                           <p className="mb-0">From <span>${carData.price_per_day.toFixed(2)}</span> / Day</p>
                        </div>
                        <span className="mr-25 mb-10"><i className="fa-regular fa-location-dot"></i> {carData.location}</span>
                        <div className="tg-tour-details-video-ratings mb-10">
                           {[...Array(5)].map((_, index) => (
                              <span key={index}>
                                 <i className={`fa-sharp fa-solid fa-star ${index < Math.floor(carData.rating) ? '' : 'text-muted'}`}></i>
                              </span>
                           ))}
                           <span className="review">({carData.total_reviews || '0 Reviews'})</span>
                        </div>
                     </div>
                  </div>
               </div>
