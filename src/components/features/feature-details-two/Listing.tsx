            ...
            <div className="row align-items-end">
               <div className="col-lg-9">
                  <div className="tg-location-section-title mb-40">
                     <h5 className="tg-section-subtitle mb-15 wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".9s">Most Popular Car Rental Deals </h5>
                     <h2 className="mb-15 text-capitalize wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".9s">Our Popular Vehicles</h2>
                  </div>
               </div>
               <div className="col-lg-3">
                  <div className="tg-location-3-btn text-end wow fadeInUp mb-40" data-wow-delay=".6s" data-wow-duration=".9s">
                     <Link to="/car-listing" className="tg-btn tg-btn-gray tg-btn-switch-animation">
            ...
            <div className="row">
               <div className="col-12">
                  <Swiper {...setting} modules={[Autoplay, Pagination]} wrapperClass="mb-35" className="swiper-container tg-listing-slider p-relative fix">
                     {car_rental_data.filter((items) => items.page === "car_rental").slice(0, 5).map((item) => (
