...
interface CarFeatureListProps {
   carData: CarRentalType;
}

const CarFeatureList = ({ carData }: CarFeatureListProps) => {
   const list_data: DataType[] = [
      ...
      },
      {
         ...
         sub_title: "Luggage",
         title: carData.luggage_capacity,
      },
   ];
