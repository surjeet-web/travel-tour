...
import { type TravelPackageType } from "../../../data/TravelPackageData";
...
interface FeatureListProps {
   packageData: TravelPackageType;
}

const FeatureList = ({ packageData }: FeatureListProps) => {
   const list_data: DataType[] = [
      ...
      },
      {
         ...
         sub_title: "Destination",
         title: packageData.destination,
      },
      {
         id: 3,
         icon: (<><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
         ...
         title: packageData.group_size || "Not specified",
      },
      {
         id: 4,
         ...
         sub_title: "Accommodation",
         title: packageData.accommodation || "Not specified",
      },
   ];
   return (
      <ul>
