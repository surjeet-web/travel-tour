         ...
         <div className="tg-tour-details-area pt-35 pb-25">
            <div className="container">
               <div className="text-center">
                  ...
                  <Link to="/travel-packages" className="tg-btn tg-style1">
                     Back to Packages
                  </Link>
               </div>
            </div>
               ...
               <div className="row align-items-end mb-35">
                  <div className="col-xl-9 col-lg-8">
                     <div className="tg-tour-details-video-title-wrap">
                        <h2 className="tg-tour-details-video-title mb-15">{packageData.title}</h2>
                        <div className="tg-tour-details-video-location d-flex flex-wrap">
                           <span className="mr-25"><i className="fa-regular fa-location-dot"></i> {packageData.location}</span>
                           <div className="tg-tour-details-video-ratings">
                              {[...Array(5)].map((_, index) => (
                                 <span key={index}>
                                    <i className={`fa-sharp fa-solid fa-star ${index < Math.floor(packageData.rating) ? '' : 'text-muted'}`}></i>
                                 </span>
                              ))}
                              <span className="review">({packageData.total_reviews || '0 Reviews'})</span>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div className="row gx-15 mb-25">
                  <div className="col-lg-7">
                     <div className="tg-tour-details-video-thumb mb-15">
                        <img className="w-100" src={packageData.thumb} alt={packageData.title} />
                     </div>
                  </div>
                  ...
                  <div className="row align-items-center">
                     <div className="col-lg-8">
                        <div className="tg-tour-details-video-feature-list">
                           <FeatureList packageData={packageData} />
                        </div>
                     </div>
                     <div className="col-lg-4">
                        <div className="tg-tour-details-video-feature-price mb-15">
                           <p>From <span>${packageData.price.toFixed(2)}</span> / Person</p>
                        </div>
                     </div>
                  </div>
               </div>
