...
const Testimonial = () => {
   ...
   return (
      <div className="tg-testimonial-area tg-testimonial-su-wrap p-relative pt-160 pb-50">
         <img className="tg-testimonial-su-shape d-none d-xxl-block" src="/assets/img/testimonial/su/shape.png" alt="" />
         <img className="tg-testimonial-su-shape-2 d-none d-lg-block" src="/assets/img/testimonial/su/shape-2.png" alt="" />
